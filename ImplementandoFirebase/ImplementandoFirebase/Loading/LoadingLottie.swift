...
//
//  Created by Eduardo Felipe das Neves Abido on 14/09/24.
//
...
final class LoadingLottie: UIView {
    ...
    static var shared = LoadingLottie()
    
    lazy var animationLottieView: LottieAnimationView = {
        let loading = LottieAnimationView(name: "loading") // Espera o JSON com esse nome
